...
(function() {
  jQuery(function() {
    return $('#new_property').fileupload({
      datatype: "script",
      add: function(e, data) {
    ...
    Plugin.prototype.structure = function() {
        ...
        if (this.s.controls && this.$items.length > 1) {
            controls = '<div class="lg-actions">' +
                '<i class="lg-prev lg-icon">' + this.s.prevHtml + '</i>' +
                '<i class="lg-next lg-icon">' + this.s.nextHtml + '</i>' +
                '</div>';
        }
...
(function() {
    ...
    Autoplay.prototype.controls = function() {
        var _this = this;
        var _html = '<i class="lg-autoplay-button lg-icon"></i>';
    ...
    Fullscreen.prototype.init = function() {
        ...
        if (this.core.s.fullScreen) {
            ...
            if (!document.fullscreenEnabled && !document.webkitFullscreenEnabled &&
                ...
                fullScreen = '<i class="lg-fullscreen lg-icon"></i>';
...
(function() {
    ...
    Thumbnail.prototype.toogle = function() {
        ...
        if (_this.core.s.toogleThumb) {
            ...
            _this.$thumbOuter.append('<i class="lg-toogle-thumb lg-icon"></i>');
...
(function() {
    ...
    Zoom.prototype.init = function() {
        ...
        var _this = this;
        var zoomIcons = '<i id="lg-zoom-in" class="lg-icon"></i><i id="lg-zoom-out" class="lg-icon"></i>';

        if (_this.core.s.actualSize) {
            zoomIcons += '<i id="lg-actual-size" class="lg-icon"></i>';
        }
...
(function() {
    ...
    Share.prototype.init = function() {
        var _this = this;
        var shareHtml = '<i id="lg-share" class="lg-icon">' +
            '<ul class="lg-dropdown" style="position: absolute;">';
        shareHtml += _this.core.s.facebook ? '<li><a id="lg-share-facebook" target="_blank"><i class="lg-icon"></i><span class="lg-dropdown-text">' + this.core.s.facebookDropdownText + '</span></a></li>' : '';
        shareHtml += _this.core.s.twitter ? '<li><a id="lg-share-twitter" target="_blank"><i class="lg-icon"></i><span class="lg-dropdown-text">' + this.core.s.twitterDropdownText + '</span></a></li>' : '';
        shareHtml += _this.core.s.googlePlus ? '<li><a id="lg-share-googleplus" target="_blank"><i class="lg-icon"></i><span class="lg-dropdown-text">' + this.core.s.googlePlusDropdownText + '</span></a></li>' : '';
        shareHtml += _this.core.s.pinterest ? '<li><a id="lg-share-pinterest" target="_blank"><i class="lg-icon"></i><span class="lg-dropdown-text">' + this.core.s.pinterestDropdownText + '</span></a></li>' : '';
        shareHtml += '</ul></i>';
